...
const GUIDE_ITEMS = [
    ...
    },
    {
        ...
        features: ["AES-256 암호화", "개인정보보호법 준수", "정기 보안 감사"],
    },
];
...
export default function PayeeInfoPage() {
    ...
    const getSelectedIssueType = () => {
        return ISSUE_TYPES.find(
            (type) => type.value === formData.taxInfo.invoice_type
        );
    };
                                ...
                                >
                                            ...
                                            {PROCESS_STEPS.slice(0, 2).map((step, index) => (
                                                ...
                                                >
                                                    <div className="bg-white/60 backdrop-blur-xl rounded-xl p-6 border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300 text-center">
                                                        <div className="absolute inset-0 bg-gradient-to-br from-sky-500/5 via-transparent to-cyan-500/5 rounded-xl pointer-events-none"></div>

                                                        <div className="relative">
                                                            <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-sky-500 to-cyan-500 text-white rounded-full font-bold mb-4">
                                                                {step.number}
                                                            </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            {GUIDE_ITEMS.map((item, index) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="relative">
                                                        <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-sky-500 to-cyan-500 text-white rounded-xl mb-4 group-hover:scale-105 transition-transform">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="text-center p-4 bg-sky-50 rounded-xl border border-sky-200">
                                            <ClockIcon className="w-6 h-6 text-sky-600 mx-auto mb-2" />
                                            <p className="text-sm text-sky-600">평균 3분 소요</p>
                                        </div>
                                    ...
                                    <div className="flex justify-center pt-6">
                                        <Button
                                            ...
                                            className="w-full max-w-md h-12 bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group"
                                        >
                                            등록 시작하기
                          ...
                          `}
                            ...
                            `}
                              ...
                              {option.label}
                                    ...
                                    {(formData.recipientInfo.biz_type === "sole_proprietor" ||
                                        formData.recipientInfo.biz_type ===
                                        "corporate_business") && (
                                        <div className="space-y-6">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                        <div className="space-y-2">
                                                            ...
                                                            <Input
                                                                ...
                                                                value={
                                                                    formData.recipientInfo.foreigner_name || ""
                                                                }
                                                                onChange={(e) => {
                                                                    setFormData((prev) => ({
                                                                        ...prev,
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    <SelectTrigger
                                                        className={`h-12 bg-white/50 ${
                                                            errors.bank_name ? "border-red-400" : ""
                                                        }`}
                                                    >
                                    ...
                                    <div className="flex justify-between pt-6">
                                        ...
                                        <Button
                                            ...
                                            className="flex items-center gap-2 bg-gradient-to-r from-sky-500 to-cyan-500 hover:from-sky-600 hover:to-cyan-600"
                                        >
                                            다음
                                                ...
                                                onClick={() => {
                                                    setFormData((prev) => ({
                                                        ...
                                                        taxInfo: {
                                                            ...prev.taxInfo,
                                                            is_simple_taxpayer:
                                                                !prev.taxInfo.is_simple_taxpayer,
                                                        },
                                                    }));
                                                }}
                                                className={`
                          ...
                          간이과세자입니다
                                        ...
                                        >
                                            {ISSUE_TYPES.map((type) => (
                                                <motion.div
                                                    ...
                                                    style={{
                                                        borderColor:
                                                            formData.taxInfo.invoice_type === type.value
                                                                ? "#6366f1"
                                                                : "#e2e8f0",
                                                        backgroundColor:
                                                            formData.taxInfo.invoice_type === type.value
                                    ...
                                    {getSelectedIssueType() && (
                                        <motion.div
                                            initial={{ y: 20, opacity: 0 }}
                                            animate={{ y: 0, opacity: 1 }}
                                            className="p-4 bg-sky-50 rounded-xl border border-sky-200"
                                        >

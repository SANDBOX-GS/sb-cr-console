...
export default function PayeeInfoRegisterContainer() {
    const { getSearchParam, updateSearchParams, navigate } = useRouter();
    const { isLoggedIn, isLoading, hasPayeeInfo } = useAuth();
    ...
    useEffect(() => {
        ...
        // 3. 이미 등록된 정보가 있으면 -> /view 페이지로 튕겨내기
        if (hasPayeeInfo) {
        ...
        // ... (나머지 탭 로직)
    }, [isLoggedIn, isLoading, hasPayeeInfo, navigate]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(newErrors).length === 0) {
            ...
            const finalData = {
                ...
                is_simple_taxpayer: formData.taxInfo.is_simple_taxpayer
                    ? "Y"
                    : "N",
            };
            ...
            try {
                const response = await fetch(
                    "/api/member/payee_info_register",
                    {
                        method: "POST",
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    >
                        ...
                        <TabsContent value="guide" className="space-y-6">
                            <GuideContainer
                                handleStartAccountInfo={handleStartAccountInfo}
                            />
                        </TabsContent>
